    ...
    <div class="columns is-mobile center content">
      ...
      <div class="column is-half oxygen">
        ...
        <form (ngSubmit)="submitForm()" #loginForm="ngForm">
          ...
          <!-- Title -->
          <h1 class="title is-4 has-text-centered">Register for an account</h1>
          ...
          <div class="field">
            <p class="control">
              ...
              <input name="email" class="input" type="text" placeholder="First name" 
                [(ngModel)]="firstName" 
                #firstNameInput="ngModel" 
                required>
            </p>

            <!-- First name input validation: displays error message if input is invalid -->
            <div class="help is-error" *ngIf="firstNameInput.invalid && firstNameInput.touched">
              <p class="has-text-danger">First name is required.</p>
            </div>
          ...
          <div class="field">
            <p class="control">
              ...
              <input name="email" class="input" type="text" placeholder="Last name" 
                [(ngModel)]="lastName" 
                #lastNameInput="ngModel" 
                required>
            </p>

            <!-- Last name input validation: displays error message if input is invalid -->
            <div class="help is-error" *ngIf="lastNameInput.invalid && lastNameInput.touched">
              <p class="has-text-danger">Last name is required.</p>
            </div>
